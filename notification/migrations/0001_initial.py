...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_noticesetting', (
            ...
            ('backend', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Adding unique constraint on 'NoticeSetting', fields ['user', 'notice_type', 'backend']
        db.create_unique('notification_noticesetting', ['user_id', 'notice_type_id', 'backend'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'NoticeSetting', fields ['user', 'notice_type', 'backend']
        db.delete_unique('notification_noticesetting', ['user_id', 'notice_type_id', 'backend'])
